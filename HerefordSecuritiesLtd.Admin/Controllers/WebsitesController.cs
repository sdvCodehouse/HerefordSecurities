...
namespace HerefordSecuritiesLtd.Admin.Controllers
{
    public class WebsitesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Sitename,Sitelink,WorkExperienceId")] Website website)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Sitename,Sitelink,WorkExperienceId")] Website website)
        {
            if (ModelState.IsValid)
            {
